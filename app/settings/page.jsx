...
export default function Settings () {
    ...
    useEffect(() => {
        ...
        setDeleted([
            'mails', 'chats', 'reports', 'categories', 'products',
            'coupons', 'bookings', 'payouts',
            'supervisors', 'admins', 'owners', 'guests',
        ]);
                    ...
                    <div className="relative switch">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            ...
                            <div className="panel space-y-4 default">
                                ...
                                <h5 className="font-semibold text-lg">{config.text.user_register}</h5>

                                <p className='pb-1'>{config.text.options_user_register}</p>
                            ...
                            <div className="panel space-y-4 default">
                                ...
                                <h5 className="font-semibold text-lg">{config.text.user_login}</h5>

                                <p className='pb-1'>{config.text.options_user_login}</p>
                            ...
                            <div className="panel space-y-4 default">
                                ...
                                <h5 className="font-semibold text-lg">{config.text.add_coupons}</h5>

                                <p className='pb-1'>{config.text.options_add_coupons}</p>
                            ...
                            <div className="panel space-y-4 default">
                                ...
                                <h5 className="font-semibold text-lg">{config.text.allow_coupons}</h5>

                                <p className='pb-1'>{config.text.options_allow_coupons}</p>
                            ...
                            <div className="panel space-y-4 default">
                                ...
                                <h5 className="font-semibold text-lg">{config.text.allow_withdraws}</h5>

                                <p className='pb-1'>{config.text.options_allow_withdraws}</p>
                            ...
                            <div className="panel space-y-4 default">
                                ...
                                <h5 className="font-semibold text-lg">{config.text.allow_deposits}</h5>

                                <p className='pb-1'>{config.text.options_allow_deposits}</p>
                            ...
                            <div className="panel space-y-4 default">
                                ...
                                <h5 className="font-semibold text-lg">{config.text.close_app}</h5>
