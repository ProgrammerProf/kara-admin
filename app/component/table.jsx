...
export default function Table ({ columns, data, add, edit, delete_, search, async_search, no_search, no_add, no_edit, no_delete, btn_name }) {
    ...
    const check_empty = ( data_table ) => {
        ...
        if ( data_table.length ) document.querySelector('.datatables').classList.remove('empty');
    ...
    const searchData = () => {
        ...
        if ( !async_search ) { setInitialRecords(result); check_empty(result); }
    ...
    return (
        ...
        <div className="panel border-white-light px-0 dark:border-[#1b2e4b]">
            ...
            <div className="invoice-table">
                ...
                <div className="mb-4.5 flex flex-col gap-5 px-5 md:flex-row md:items-center select-none">
                    ...
                    <div className="flex items-center gap-2">
                        {
                            ...
                            <button type="button" className="btn btn-danger gap-2" onClick={() => deleteRow()}>
                                ...
                                <span className='font-thin tracking-wide'>Delete</span>

                            </button>
                        }
                        {
                            !no_add &&
                            <button type="button" className="btn btn-primary gap-2" onClick={() => add()}>
                                ...
                                <span className='font-thin tracking-wide'>{btn_name || 'Add New'}</span>
                ...
                <div className="datatables pagination-padding">
                    {
                        loader ? <div className='w-full h-[20rem] relative'><Loader /></div> :
                        <DataTable
