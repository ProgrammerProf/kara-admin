...
export default function Form_Owner ({ id }) {
    ...
    const get_item = async() => {
        ...
        setLoader(false);
        document.title = `${config.text.edit_owner} | ${response.data.name || ''}`;
    ...
    useEffect(() => {
        ...
        document.title = id ? config.text.edit_owner : config.text.add_owner;
                            ...
                            <div className="mt-4 px-4">
                                ...
                                <div className="flex justify-between lg:flex-row flex-col">
                                    ...
                                    <div className="lg:w-1/2 w-full ltr:lg:mr-6 rtl:lg:ml-6 mb-4 div-2">
                                        ...
                                        <div className="flex items-center mt-4">
                                            <label htmlFor="products" className="ltr:mr-2 rtl:ml-2 w-1/4 mb-0">{config.text.products}</label>
                                            <input id="products" type="number" min='0' value={data.products || 0} readOnly className="form-input flex-1 default" autoComplete="off"/>
                                        </div>

                                        <div className="flex items-center mt-4">
                                            <label htmlFor="visitors" className="ltr:mr-2 rtl:ml-2 w-1/4 mb-0">{config.text.visitors}</label>
                                    ...
                                    <div className="lg:w-1/2 w-full div-3">
                                        ...
                                        <div className="flex items-center mt-4">
                                            <label htmlFor="balance" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0 ltr:pl-8 rtl:pr-8">{config.text.balance}</label>
                                            <input id="balance" type="number" min='0' value={data.balance || 0} readOnly className="form-input flex-1 default" autoComplete="off"/>
                                        </div>

                                        <div className="flex items-center mt-4">
                                            <label htmlFor="orders" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0 ltr:pl-8 rtl:pr-8">{config.text.bookings}</label>
