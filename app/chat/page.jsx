                            ...
                            <ul className="whitespace-nowrap">
                                ...
                                <li onClick={() => setModel(true)}>
                                    <button>
                                        ...
                                        <span className="ltr:pr-3 rtl:pl-3">{config.text.new_message}</span>
                                    </button>
                                </li>
                                <li onClick={() => router.push('/settings')}>
                                    <button>
                                        ...
                                        <span className="ltr:pr-3 rtl:pl-3">{config.text.settings}</span>
                                    </button>
                                </li>
                                                    ...
                                                    <ul className="whitespace-nowrap">
                                                        ...
                                                        <li onClick={(e) => delete_contact(item.id, true)}>
                                                            <button>
                                                                ...
                                                                <span className="ltr:mr-4 rtl:ml-4">{config.text.delete_for_all}</span>
                                                            </button>
                                                        </li>
